...
import com.example.transportproyecto.databinding.ActivityMain3Binding
import com.example.transportproyecto.views.adapters.CommentAdapter
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            runOnUiThread {
                if (call.isSuccessful) {
                    ...
                    binding.btnAddUpdate.setText("Agregar Comentario")
